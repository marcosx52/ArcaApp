...
export function CustomerDetailScreen({ customerId }: CustomerDetailScreenProps) {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: async (updatedCustomer) => {
      queryClient.setQueryData(['customers', customerId], updatedCustomer);
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.5fr_0.85fr]">
        <CustomerForm
          ...
          description="Cambios persistidos vía PATCH /customers/:id."
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-sm">
            ...
            <div className="space-y-2 rounded-2xl border border-slate-200 p-4">
              ...
              <div className="font-medium text-slate-900">{customer.isFrequent ? 'Sí' : 'No'}</div>
            </div>
            <div className="space-y-2 rounded-2xl border border-slate-200 p-4">
              <div className="flex items-center gap-2 text-slate-500">
